  ...
  return (
    <div className={compact ? "" : "px-3 pb-24"}>
      ...
      <form
        ...
        className="mx-auto mb-2 flex max-w-xl gap-2 px-3"
      >
        <input
          value={query}
      ...
      {!compact && (
        <div className="mx-auto mb-3 flex items-center gap-1.5 px-3">
          ...
          <div className="ml-auto flex items-center rounded-lg border border-white/10">
            {[2, 3, 4, 5, 6].map((n) => (
              <button
                key={n}
